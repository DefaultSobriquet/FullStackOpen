...
Browser->>Server: Sends note content in the body<br> of a POST method to the server at <br> "/exampleapp/new_note".
Server->>Server: Updates the array of notes.
Server->>Browser: Responds to request with Status<br> Code 302 (Found) to send a redirect<br>to the same page at "/exampleapp/notes".
